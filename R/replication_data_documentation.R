...
#'
#' Replication data for Pemstein, Meserve, and Melton (2010), released as Pemstein, Meserve, and Melton 2013.
#'
#' \describe{
#' \item{uds_country}{The name of the country in the UDS release}
#' \item{year}{Calendar year. Min 1945, max 2008. }
#' \item{uds_ccode}{The correlates of war numeric code, as in the original UDS release. This is different for Yugoslavia/Serbia from the actual COW code after 2006. Use the \code{cown} variable instead for merging with COW-indexed data.}
#' \item{arat}{Democracy score from Arat, Zehra F. 1991.
#' Democracy and human rights in developing countries. Boulder: Lynne Rienner
#' Publishers. Min = 29, max = 109, n = 3873.}
#'
...
#'
#' \item{bollen}{0-100
#' index of democracy from Bollen, Kenneth A. 2001. "Cross-National Indicators
#' of Liberal Democracy, 1950-1990." 2nd ICPSR version. Chapel Hill, NC:
#' University of North Carolina, 1998. Ann Arbor, MI: Inter-university
#' Consortium for Political and Social Research, 2001. Original data available
#' at \url{http://webapp.icpsr.umich.edu/cocoon/ICPSR-STUDY/02532.xml}.}
#'
#' \item{freedomhouse}{Average
#' civil liberties + political rights score (reversed so higher values are more
#' democratic) from Freedom House. 2015. "Freedom in the World." Original data
#' available at \url{http://www.freedomhouse.org}. Goes from 1 (least
#' democratic) to 7 (most democratic). In this version index stops at 2008. It also includes a value for 1981, which the original Freedom House scores skip.}
#'
#' \item{hadenius}{0-10 index of democracy from Hadenius, Axel. 1992.
...
#'
#' \item{pacl}{Dichotomous measure of
#' democracy from Cheibub, Jose Antonio, Jennifer Gandhi, and James Raymond
#' Vreeland. 2010. "Democracy and Dictatorship Revisited." Public Choice.
#' 143(1):67-101. Original data available at
...
#'
#' \item{poliarchy}{0-10 index of democracy from Coppedge, Michael and
...
#'
#' \item{prc}{1-4 index of democracy
#' from Gasiorowski, Mark J. 1996. "An Overview of the Political Regime Change
#' Dataset." Comparative Political Studies 29(4):469-483. Available in updated
#' form in Reich, G. 2002. Categorizing Political Regimes: New Data for Old
#' Problems. Democratization 9 (4): 1-24.
#' \url{http://www.tandfonline.com/doi/pdf/10.1080/714000289}. 1= Authoritarian,
#' 2 = transitional, 3 = semidemocratic, 4 = democratic. The version in PMM's replication data is inconsistent regarding the treatment of years with transitions - it does not always obey the "31 Dec" coding rule.}
#'
...
#' Publishers.
#'
#' Bollen, Kenneth A. 2001. "Cross-National Indicators
#' of Liberal Democracy, 1950-1990." 2nd ICPSR version. Chapel Hill, NC:
#' University of North Carolina, 1998. Ann Arbor, MI: Inter-university
#' Consortium for Political and Social Research, 2001. Original data available
#' at \url{http://webapp.icpsr.umich.edu/cocoon/ICPSR-STUDY/02532.xml}.
...
#'
#' Marshall, Monty G., Ted Robert Gurr, and Keith Jaggers. 2012. "Polity
#' IV: Political Regime Characteristics and Transitions, 1800-2012." Updated to
#' 2015. Original data available from
#' \url{http://www.systemicpeace.org/polity/polity4.htm}.
#'
