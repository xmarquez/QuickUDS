...
The existing UDS scores are available for ```r nrow(extended_uds)``` country-years (```length(unique(extended_uds$country_name))``` unique countries and non-sovereign territories):
