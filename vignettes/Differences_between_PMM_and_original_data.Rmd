...
There are in total `r nrow(comparison %>% filter((!is.na(freedomhouse_pmm) & is.na(freedomhouse)) | (is.na(freedomhouse_pmm) & !is.na(freedomhouse)) | (freedomhouse_pmm != freedomhouse)))` differences between PMM's replication data and the current Freedom House data (Freedom House 2016). These differences seem to be due to data revisions since 2010 in the Freedom House dataset. 
