...
* If the selected index contains the string ```vanhanen_democratization```, the function assumes this is Vanhanen's (2012)'s index of democratization, and it will cut it into 8 intervals with the following cutoffs: 5,10,15,20,25,30, and 35 (following Pemstein, Meserve, and Melton's advice). The resulting score is ordinal from 1 to 8.
